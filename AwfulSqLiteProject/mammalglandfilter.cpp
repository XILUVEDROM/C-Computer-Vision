...
#include "ui_mammalglandfilter.h"
#include "mainwindow.h"

MammalGlandFilter::MammalGlandFilter(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::MammalGlandFilter)
{
    ui->setupUi(this);
}

MammalGlandFilter::~MammalGlandFilter()
{
    delete ui;
}

void MammalGlandFilter::on_pushButton_clicked()
{
    this->close();
}

void MammalGlandFilter::on_pushButton_2_clicked()
{
    QString tmp = "";
